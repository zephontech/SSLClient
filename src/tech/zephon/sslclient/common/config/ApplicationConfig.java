...
public final class ApplicationConfig {
    ...
    public String toString() {
        return "ApplicationConfig{" + "KEYSTOREPATH=" + KEYSTOREPATH + ", TRUSTSTOREPATH=" + TRUSTSTOREPATH + ", HTTPS_SERV_URL=" + HTTPS_SERV_URL + ", trustAllCertificate=" + trustAllCertificate + ", keystoreType=" + keystoreType + ", keymanageralgorithm=" + keymanageralgorithm + '}';
    }
